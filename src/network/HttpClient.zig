...
//
// Header *order* is fingerprinted as much as header presence: Chrome sends
...
pub const Transfer = struct {
    ...
    pub fn deinit(self: *Transfer) void {
        ...
        // res.buffer / res.stream.spare are client.allocator-backed (not on the
        // transfer arena) so their capacity is reclaimed instead of retained.
